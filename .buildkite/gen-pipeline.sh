...
baseline="test-cpu-gloo-py3_8-tf2_10_0-keras2_10_0-torch1_12_1-mxnet1_9_1-pyspark3_3_0"
...
tests=$(if [[ -n "${PIPELINE_MODE:-}" ]] && ( [[ "${BUILDKITE_BRANCH:-}" == "${BUILDKITE_PIPELINE_DEFAULT_BRANCH:-}" ]] || [[ -n "$code_files" ]] ); then
  ...
  # our baseline again
# printf "test-cpu-gloo-py3_8-tf2_10_0-keras2_10_0-torch1_12_1-mxnet1_9_1-pyspark3_3_0 "
  printf "test-cpu-mpich-py3_8-tf2_10_0-keras2_10_0-torch1_12_1-mxnet1_9_1-pyspark3_3_0 "
  printf "test-cpu-oneccl-py3_8-tf2_10_0-keras2_10_0-torch1_12_1-mxnet1_9_1-pyspark3_3_0 "
  printf "test-cpu-openmpi-py3_8-tf2_10_0-keras2_10_0-torch1_12_1-mxnet1_9_1-pyspark3_3_0 "
  # note: we test openmpi-gloo mpi kind in this variation in each of [cpu, gpu, mixed]
  printf "test-cpu-openmpi-gloo-py3_8-tf2_10_0-keras2_10_0-torch1_12_1-mxnet1_9_1-pyspark3_3_0 "
  ...
  printf "test-cpu-gloo-py3_7-tf1_15_5-keras2_2_4-torch1_8_1-mxnet1_5_1_p0-pyspark3_3_0 "
  printf "test-cpu-gloo-py3_8-tf2_8_2-keras2_8_0-torch1_10_2-mxnet1_7_0_p2-pyspark3_3_0 "
  printf "test-cpu-gloo-py3_8-tf2_9_1-keras2_9_0-torch1_11_0-mxnet1_8_0_p0-pyspark3_3_0 "
  # our baseline again
# printf "test-cpu-gloo-py3_8-tf2_10_0-keras2_10_0-torch1_12_1-mxnet1_9_1-pyspark3_3_0 "
  printf "test-cpu-openmpi-gloo-py3_8-tfhead-keras_none-torchhead-mxnethead-pyspark3_3_0 "
  ...
  printf "test-gpu-gloo-py3_7-tf1_15_5-keras2_2_4-torch1_8_1-mxnet1_5_1_p0-pyspark3_3_0 "
  # here we deviate from mxnet==1.7.0.post2 as there is none for cu101, only post1
  printf "test-gpu-gloo-py3_8-tf2_8_2-keras2_8_0-torch1_10_2-mxnet1_7_0_p1-pyspark3_3_0 "
  printf "test-gpu-gloo-py3_8-tf2_9_1-keras2_9_0-torch1_11_0-mxnet1_8_0_p0-pyspark3_3_0 "
  printf "test-gpu-openmpi-gloo-py3_8-tf2_10_0-keras2_10_0-torch1_12_1-mxnet1_9_1-pyspark3_3_0 "
  printf "test-gpu-openmpi-gloo-py3_8-tfhead-keras_none-torchhead-mxnethead-pyspark3_3_0 "
  # these are the lowest framework versions that Horovod compiles with, but they are not tested
  printf "test-gpu-openmpi-gloo-py3_7-tfmin-kerasmin-torchmin-mxnetmin-pysparkmin "

  # and one final test with mixed cpu+gpu
  printf "test-mixed-openmpi-gloo-py3_8-tf2_10_0-keras2_10_0-torch1_12_1-mxnet1_9_1-pyspark3_3_0 "
...
run_gloo_integration() {
  ...
  if [[ ${test} == ${baseline} ]] || [[ ${test} == test-cpu-gloo-*-tf1_* ]] || [[ ${test} != *pyspark3_3_0* ]]; then
    run_test "${test}" "${queue}" \
  ...
  if [[ ${test} == ${baseline} ]] || [[ ${test} != *pyspark3_3_0* ]]; then
    run_test "${test}" "${queue}" \
